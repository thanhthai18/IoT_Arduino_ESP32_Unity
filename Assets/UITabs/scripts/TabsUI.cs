...
namespace EasyUI.Tabs
{
    ...
    public abstract class TabsUI : MonoBehaviour
    {
        ...
        public static event Action<int> eventOnTabClick;
        ...
        public void GetTabBtns(int indexTabBegin)
        {
            ...
            previous = current = indexTabBegin;

            tabColorActive = tabBtns[0].uiImage.color;
            tabColorInactive = tabBtns[1].uiImage.color;

            tabBtns[indexTabBegin].uiButton.interactable = false;
            tabContent[indexTabBegin].SetActive(true);
        ...
        private void OnTabButtonClicked(int tabIndex)
        {
            if (current != tabIndex)
            {
                ...
                eventOnTabClick?.Invoke(tabIndex);
            }
        }
